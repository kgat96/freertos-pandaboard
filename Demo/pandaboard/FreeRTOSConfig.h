/*
	...
	added support for Versatile Express and PandaBoard.
...
/* Select the Platform 0=Realview-PBX-A9, 1=nVidia-Tegra2, 2=Versatile-Express, 3=Pandaboard */
#define configPLATFORM							( 3 )
	...
	#define configCPU_CLOCK_HZ				( ( unsigned portLONG ) 1000000000 )
	#define configCPU_PERIPH_HZ				( configCPU_CLOCK_HZ / 4 )
	#define configUART_PORT					( 1 )
#elif configPLATFORM == 2
	#define configCPU_CLOCK_HZ				( ( unsigned portLONG ) 400000000 )
	#define configCPU_PERIPH_HZ				( configCPU_CLOCK_HZ / 2 )
	#define configUART_PORT					( portCORE_ID() )
#elif configPLATFORM == 3
	#define configCPU_CLOCK_HZ				( ( unsigned portLONG ) 700000000 )
	#define configCPU_PERIPH_HZ				( configCPU_CLOCK_HZ / 2 )
	#define configUART_PORT					( 2 )

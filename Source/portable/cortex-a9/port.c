...
/*	pulSrc = &_etext;
	...
	// Enable D-side prefetch. TODO: Does not work on the Pandaboard for some reason?
#if configPLATFORM != 3
...
#else
	// For other platforms, just mark all memory as non-cached.
	for(i=0;i<4096;i++) PageTable[i]=(i<<20)|0x0de2;
#endif
